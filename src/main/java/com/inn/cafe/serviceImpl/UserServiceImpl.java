...
public class UserServiceImpl implements UserService {
    ...
    public ResponseEntity<String> signUp(Map<String, String> requestMap) {
        log.info("Entramos aca al metodo Inside signup {}",requestMap);
        try {
        ...
        try{
            if(jwtFilter.isAdmin()){
               ...
               if(!optional.isEmpty()){
                   ...
                   return CafeUtils.getResponseEntity("User id doesn not exit", HttpStatus.OK);
               }
            }
            else{
    ...
    private void sendMailToAllAdmin(String status, String user, List<String> allAdmin) {
        ...
        if(status!= null && status.equalsIgnoreCase("true")){
            emailUtils.setSimpleMessage(jwtFilter.getCurrentUser(),"Account Approved","USER:- "+ user + "\n is approved by \nADMIN:-"+ jwtFilter.getCurrentUser(),allAdmin);
        }
        else{
            emailUtils.setSimpleMessage(jwtFilter.getCurrentUser(),"Account disabled","USER:- "+ user + "\n is disabled by \nADMIN:-"+ jwtFilter.getCurrentUser(),allAdmin);
        }
    }
